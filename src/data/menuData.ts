...
export const SEED_CATEGORIES: Category[] = [
  { id: "mangal", name_ru: "Кавказский мангал", name_en: "Caucasian Grill", sort_order: 10, is_active: true },
  ...
  { id: "cold", name_ru: "Холодные закуски", name_en: "Cold Appetizers", sort_order: 50, is_active: true },
  { id: "hotapps", name_ru: "Горячие закуски", name_en: "Hot Appetizers", sort_order: 60, is_active: true },
  { id: "khachapuri", name_ru: "Хачапури из печи", name_en: "Khachapuri", sort_order: 70, is_active: true },
...
const mk = (
  ...
  id: `${categoryId}-${name_ru.toLowerCase().replace(/[^\p{L}\p{N}]+/gu, "-").slice(0, 40)}-${ord()}`,
  categoryId,
  name_ru,
  price,
  is_available: true,
...
export const SEED_ITEMS: MenuItem[] = [
  // КАВКАЗСКИЙ МАНГАЛ
  mk("mangal", "Каре барашка", 79000, { weight: "100 гр", description_ru: "Подаем на тонком лаваше с соусом сацебели", is_popular: true }),
  ...
  mk("mangal", "Хачапури на огне", 77000, { weight: "250 гр", description_ru: "Сыр сулугуни в тонком тесте на шампуре", is_popular: true }),
  ...
  mk("mangal", "Овощи на мангале", 67000, { weight: "400 гр", description_ru: "Болгарский перец, баклажан, кабачки, кукуруза, помидоры, шампиньоны, лук" }),
  ...
  mk("hot", "Медальоны из говяжьей вырезки", 198000, { description_ru: "Под сливочным соусом с картофельным пюре", is_popular: true }),
  ...
  mk("hot", "Цыпленок чкмерули", 146000, { description_ru: "Обжаренный до корочки цыпленок в сливочно-чесночном соусе", is_popular: true }),
  mk("hot", "Бон филе с овощами хороваи", 145000),
  mk("hot", "Чакапули", 122000, { description_ru: "Мякоть барашка, тархун" }),
  mk("hot", "Орагули с телятиной и грибами", 138000, { description_ru: "Запекается в кеци с сыром" }),
  mk("hot", "Чашушули из баранины", 128000, { description_ru: "Мясо, тушеное в собственном соку и томатном соусе" }),
  ...
  mk("hot", "Стейк из форели", 175000, { description_ru: "Подаем с картофельными дольками и голландским соусом" }),
  ...
  mk("hot", "Метехи", 134000, { description_ru: "Бон филе с жареной картошкой, вяленым луком, залеваем под сливочным соусом" }),

  // ПЕРВЫЕ БЛЮДА
  mk("soups", "Суп харчо", 62000, { description_ru: "Традиционный ароматный наваристый суп из говядины", is_popular: true }),
  mk("soups", "Домашняя куриная лапша", 41000, { description_ru: "Лапша собственного производства" }),
  ...
  mk("salads", "Боржоми", 84000, { description_ru: "Авокадо, томаты, огурцы, шпинат, оливковое масло" }),
  mk("salads", "Тбилиси", 76000, { description_ru: "Фасоль, отварная говядина, болгарский перец, картофель и домашняя грузинская специя" }),
  ...
  mk("salads", "Капрезе", 78000, { description_ru: "Помидоры, моцарелла, руккола, оливковое масло, песто соус" }),
  ...
  mk("cold", "Пхали ассорти", 87000, { description_ru: "Закуска из шпината, свеклы и моркови с орехом" }),
  ...
  mk("hotapps", "Овощное ассорти по-грузински", 72000, { description_ru: "Помидоры, огурцы, болгарский перец, редис, острая стручковая перец, кинза, мята" }),
  ...
  mk("khachapuri", "Кубдари", 107000, { weight: "500 гр", description_ru: "Традиционный хачапури с мясом и свенскими специями" }),
  ...
  // ХЛЕБ
  mk("bread", "Хлебная корзина", 27000, { description_ru: "Пури собственного производства, лаваш и черный хлеб" }),
  mk("bread", "Пури", 18000),
